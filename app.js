...
const hot10RequestExamples = ['Adoの唱', 'マツケンサンバII', 'ゆずの夏色', 'ミセスの青と夏', 'スピッツのチェリー', 'サザンの真夏の果実', 'B’zのultra soul', 'Vaundyの怪獣の花唄', 'あいみょんのマリーゴールド', 'いきものがかりのYELL', '奥山熊雄のいもめとてがめ', '石投げ踊り'];
